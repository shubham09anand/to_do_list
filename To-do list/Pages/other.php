...
$fetchQuery = "SELECT * FROM `tasktable` WHERE taskType = 'other' and userID = 1";
...
<body class="">
     ...
     <div class="flex md:space-x-5">
          ...
          <div class="w-full lg:w-full mx-auto min-h-fit mt-5 max-h-full bg-gray-50 rounded-xl p-5 space-y-3">
               <div class="text-3xl text-left mt-2 sm:text-5xl font-semibold mb-8">Other</div>
          ...
          <div id="task" class="w-full sm:w-2/5 min-h-fit shadow-xl p-5 space-y-5 mt-5 rounded-xl absolute md:static right-0 ">
               ...
               <?php } ?>
               <div class="space-y-5 px-2">
                    <div id="taskcompleteButton" class="mt-20 text-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-green-500 rounded-md hover:bg-green-600 sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl">Done</div>
                    <div id="taskeditButton" class="mt-20 text-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-yellow-500 rounded-md hover:bg-yellow-600 sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl"> Edit Task</div>
                    <div id="taskdeleteButton" class="text-center justify-center  px-6 py-3 mb-2 text-lg text-white bg-red-600 rounded-md hover:bg-red-700 sm:w-auto sm:mb-0" data-primary="green-400" data-rounded="rounded-2xl"> Delete Task</div>
               </div>
          </div>
     ...
     <script>
          document.getElementById("todoType").innerHTML = 'Other';
     </script>
