...
$fetchQuery = "SELECT * FROM `tasktable` WHERE taskType = 'work' and userID = 1";
...
<body class="">
     ...
     <div class="flex md:space-x-5">
          ...
          <div class="w-full lg:w-full mx-auto min-h-fit mt-5 max-h-full bg-gray-50 rounded-xl p-5 space-y-3">
               <div class="text-3xl text-left mt-2 sm:text-5xl font-semibold mb-8">Work</div>
     ...
     <script>
          document.getElementById("todoType").innerHTML = 'Work';
     </script>
