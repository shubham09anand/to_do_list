                         ...
                         <div class="scroll space-y-3 m-2 ">
                              <div class="w-[375px] min-h-[20px] max-h-[320px] overflow-y-scroll p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                                   <div class="flex justify-between">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-x-square h-5 w-5 mt-1 bg-red-500 rounded-sm" viewBox="0 0 16 16" data-userId = <?php echo $data['stickyID'] ?>  data-taskID = <?php echo $data['UserId'] ?>  >
