               ...
               <div class="w-full bg-white h-screen mt-5 rounded-xl px-4">
                    ...
                    <div class="hidden" id="updateProfileForm">
                         <div class="flex w-full overflow-hidden flex-wrap h-fit pb-10">
                              <div class="flex flex-wrap w-full h-full">
                                   <div
                                        class="bg-white md:mx-auto rounded shadow-xl w-[1100px] mx-auto overflow-hidden mt-10">
                                        <div class="h-[150px] bg-contain"><img draggable="false"
                                        ...
                                        <div class="px-5 py-2 flex flex-col gap-3 pb-6 relative">
                                             <div class="flex justify-between">
                                                  <div class="flex">
                                                       <div
                                                            class='h-[100px] shadow-md w-[100px] rounded-full border-4 overflow-hidden -mt-14 border-white flex'>
                                                            <div>
                                                                 <img draggable="false"
                                                       ...
                                                       <div class="w-8 h-8 scale-105 rounded-full bg-black absolute">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 class="w-6 h-6 mt-1 mx-auto" fill="white"
                                                  ...
                                                  <div class="w-16 h-16 rounded-full p-3 bg-black -mt-10">
                                                       <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10"
                                                            fill="white" class="bi bi-camera" viewBox="0 0 16 16">
                                                            <path
                                                                 d="M15 12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1.172a3 3 0 0 0 2.12-.879l.83-.828A1 1 0 0 1 6.827 3h2.344a1 1 0 0 1 .707.293l.828.828A3 3 0 0 0 12.828 5H14a1 1 0 0 1 1 1v6zM2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4H2z" />
                                                            <path
                                                                 d="M8 11a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm0 1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM3 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" />
                                             ...
                                             <textarea name="userDescription" id="userDescription" value="dewdew"
                                                  class="w-full border py-1 p-3 border-gray-300 rounded-md focus:outline-none resize-none"
                                                  id="userDescription"></textarea>
                                             <div class="text-gray-700 -ml-5 sm:-ml-0">
                                                  <div class="grid md:grid-cols-2 text-sm gap-3 space-y-2">
                                                       <div class="grid grid-cols-2">
                                                            ...
                                                            <input id="userFirstName" type="text"
                                                                 ...
                                                                 class="text-center w-44 border py-1 border-gray-300 rounded-md focus:outline-none">
                                                       </div>
                                                       <div class="grid grid-cols-2">
                                                       ...
                                                       <div class="grid grid-cols-2">
                                                            <label for="userDOB"
                                                                 class="px-4 font-semibold">Birthday</label>
                                                       ...
                                                       <div class="grid grid-cols-2">
                                                            <label for="userGender"
                                                                 class="px-4 font-semibold">Gender</label>
                                                       ...
                                                       <div class="grid grid-cols-2">
                                                            <label for="userPhoneNumber"
                                                                 class="px-4 font-semibold">Contact
                                                                 No.</label>
                                                       ...
                                                       <div class="grid grid-cols-2">
                                                            <label for="userCountry"
                                                                 class="px-4 font-semibold">Country</label>
                                                       ...
                                                       <div class="grid grid-cols-2">
                                                            <label for="userState"
                                                                 class="px-4 font-semibold">State</label>
                                                            <input id="userState" type="text"
                                                                 value="$user_data['first_name']"
                                                                 class="text-center w-44 border py-1 border-gray-300 rounded-md focus:outline-none">
                                                       </div>
                                                       <div class="grid grid-cols-2 relative">
                                                            <label for="userCity"
                                                                 class="px-4 font-semibold">City</label>
                                                  ...
                                                  <div id="save"
                                                       class="hidden px-3 py-1 rounded-sm bg-blue-500 text-black text-lg font-medium w-fit ml-3">
                                                       Save</div>
                                             </div>
                                        </div>
                                   </div>
                    ...
                    <div class="">
                         <div id="resetPassword"
                              class="max-w-lg mx-auto my-32 bg-white p-8 rounded-xl shadow-xl shadow-slate-300">
                         ...
                         <div class="mt-20 font-sans leading-tight min-h-screen bg-grey-lighter p-8">
                              <div class="w-1/2 mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
                                   ...
                                   <div class="border-b px-4 pb-6">
                                        ...
                                        <div class="flex">
                                             <button
                                                  class="flex-1 rounded-full bg-blue-600 hover:bg-blue-700 text-white antialiased font-bold hover:bg-blue-dark px-4 py-2 mr-2">Delete</button>
                                        </div>
                                   </div>
                              </div>
                         </div>
