          ...
          function checkForm(){
                    if (document.form.userFirstName.value == ""){
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("firstnameWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("lastnameWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("CountryWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("StateWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("CityWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
                         ...
                         setTimeout(()=>{
                              ...
                              document.getElementById("descriptionWarning").style.transition = "opacity 2000ms";
                         }, 2000)
                    }
          ...
          reader.onload = () => {
               ...
               img.className = "w-32 h-32 rounded-full bg-cover absolute z-20 overflow-hidden";
               img.src = imgUrl;
